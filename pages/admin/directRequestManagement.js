...
import AD19 from "../../src/Components/Routes/Admin/AD19";
...
const DirectRequestManagement = () => {
  ...
  return (
    <AdminLayout title={`ADMIN | 1:1 문의`}>
      <AD19 />
    </AdminLayout>
  );
};

export default withApollo(DirectRequestManagement);
