...
import AD22 from "../../src/Components/Routes/Admin/AD22";
...
const MainBannerCreateManagement = () => {
  ...
  return (
    <AdminLayout title={`ADMIN | 메인베너 등록`}>
      <AD22 />
    </AdminLayout>
  );
};

export default withApollo(MainBannerCreateManagement);
