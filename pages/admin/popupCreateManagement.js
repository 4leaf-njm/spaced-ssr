...
import AD25 from "../../src/Components/Routes/Admin/AD25";
...
const PopupCreateManagement = () => {
  ...
  return (
    <AdminLayout title={`ADMIN | 팝업 등록`}>
      <AD25 />
    </AdminLayout>
  );
};

export default withApollo(PopupCreateManagement);
