...
import AD28 from "../../src/Components/Routes/Admin/AD28";
...
const MobileMainBannerCreateManagement = () => {
  ...
  return (
    <AdminLayout title={`ADMIN | 모바일 베너 등록`}>
      <AD28 />
    </AdminLayout>
  );
};

export default withApollo(MobileMainBannerCreateManagement);
