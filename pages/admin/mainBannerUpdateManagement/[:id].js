...
import AD21 from "../../../src/Components/Routes/Admin/AD21";
...
const MainBannerUpdateManagement = () => {
  ...
  return (
    <AdminLayout title={`ADMIN | 메인베너 수정`}>
      <AD21 />
    </AdminLayout>
  );
};

export default withApollo(MainBannerUpdateManagement);
