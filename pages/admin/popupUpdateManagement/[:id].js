...
import AD24 from "../../../src/Components/Routes/Admin/AD24";
...
const PopupUpdateManagement = () => {
  ...
  return (
    <AdminLayout title={`ADMIN | 팝업 수정`}>
      <AD24 />
    </AdminLayout>
  );
};

export default withApollo(PopupUpdateManagement);
